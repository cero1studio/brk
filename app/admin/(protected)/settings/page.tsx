  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Input
              id="siteName"
              defaultValue="BRK Performance Brakes"
          ...
          <div className="space-y-2">
            ...
            <Input
              id="adminEmail"
              type="email"
              defaultValue="admin@brkbrakes.com"
              className="bg-input border-border focus:border-primary"
            />
          </div>
          <div className="flex items-center space-x-2">
            <Switch id="maintenanceMode" disabled />
            <Label htmlFor="maintenanceMode" className="text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <p className="text-sm text-muted-foreground">
            Los ajustes de tema y apariencia se gestionan globalmente. Las opciones de personalización avanzada estarán
            disponibles aquí en el futuro.
          </p>
          <div className="space-y-2">
            ...
            <Input
              ...
              type="file"
              disabled
              className="bg-input border-border focus:border-primary cursor-not-allowed"
            />
      ...
      <p className="text-xs text-muted-foreground text-center">
        La página de configuración es actualmente para demostración. La funcionalidad es limitada.
      </p>
    </div>
  )
}
