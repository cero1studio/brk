...
const productSchema = z.object({
  ...
  largo_mm: z.string().nullable().optional(),
  ancho_mm: z.string().nullable().optional(),
  espesor_mm: z.string().nullable().optional(),
  x_juego_pastilla: z.coerce.number().nullable().optional(),
  diametro_a_mm: z.string().nullable().optional(),
  alto_b_mm: z.string().nullable().optional(),
  espesor_c_mm: z.string().nullable().optional(),
  espesor_min_mm: z.string().nullable().optional(),
  agujeros: z.coerce.number().nullable().optional(),
  diametro_interno_a_mm: z.string().nullable().optional(),
  diametro_orificio_central_c_mm: z.string().nullable().optional(),
  altura_total_d_mm: z.string().nullable().optional(),
  diametro_interno_maximo: z.string().nullable().optional(),
